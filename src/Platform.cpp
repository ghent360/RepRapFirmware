...
#elif __LPC17xx__ || STM32F4 || STM32F7
...
#elif __LPC17xx__ || SAME5x || STM32F4 || STM32F7
	// nothing to do here
#else
...
#if defined(DUET3) || defined(DUET3MINI) || defined(__LPC17xx__) || defined(STM32F4) || defined(STM32F7)
...
#elif defined(__LPC17xx__) || defined(STM32F4) || defined(STM32F7)
